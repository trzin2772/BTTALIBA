...
const simih = async (text) => {
	try {
		const sami = await fetch(`https://simsumi.herokuapp.com/api?text=${text}&lang=pt`, {method: 'GET'})
		const res = await sami.json()
		return res.success
	} catch {
		return 'Infelizmente n?o tenho respostas para isso'
	}
}
...
const banner = cfonts.render(('MIA|BOT|1.1'), {
    font: 'block',
    color: 'red',
    align: 'center',
    gradient: ["red","white"],
